...
wait
python3 src/temporal_vae.py --ex wo_triplet_r0 --batch 64 --epoch 1000 --data colon --ndeconv 3 --step 1 --full --classifier 1 --rec 0
wait
python3 src/temporal_vae.py --ex all_loss_c1 --batch 32 --epoch 1000 --data colon --ndeconv 3 --step 1 --full --classifier 1 --triplet
wait
python3 src/temporal_vae.py --ex all_loss_r0 --batch 64 --epoch 1000 --data colon --ndeconv 3 --step 1 --full --classifier 1 --rec 0 --triplet
wait
